...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap transition-all outline-none aria-invalid:border-outline-red-3 aria-invalid:shadow-focus-red aria-invalid:ring-destructive/20 disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
      ...
      size: {
        sm: "h-7 rounded text-base px-2 has-[>svg]:px-2 [&_svg:not([class*='size-'])]:size-4",
        md: "h-8 rounded text-base font-medium px-2.5 has-[>svg]:px-2.5 [&_svg:not([class*='size-'])]:size-4.5",
        lg: "h-10 rounded-md text-lg font-medium px-3 has-[>svg]:px-3 [&_svg:not([class*='size-'])]:size-5",
        xl: "h-11.5 rounded-lg text-xl font-medium px-3.5 has-[>svg]:px-3.5 [&_svg:not([class*='size-'])]:size-6",
        "2xl": "h-13 rounded-xl text-2xl font-medium px-3.5 has-[>svg]:px-3.5 [&_svg:not([class*='size-'])]:size-6",
      },
      theme: {
    ...
    compoundVariants: [
      ...
      // Outline buttons
      {
        ...
        theme: "gray",
        className:
          "text-ink-gray-7 border border-outline-gray-2 hover:border-outline-gray-3 active:border-outline-gray-4 active:bg-surface-gray-4 disabled:bg-surface-gray-2 disabled:text-ink-gray-4 disabled:border-outline-gray-2",
      },
      {
        variant: "outline",
        theme: "blue",
        className:
          "text-ink-blue-4 border border-outline-blue-2 hover:border-outline-blue-3 active:border-outline-blue-4 active:bg-surface-blue-4 disabled:bg-surface-blue-2 disabled:text-ink-blue-2 disabled:border-outline-blue-2",
      },
      {
        variant: "outline",
        theme: "green",
        className:
          "text-ink-green-4 border border-outline-green-2 hover:border-outline-green-3 active:border-outline-green-4 active:bg-surface-green-4 disabled:bg-surface-green-2 disabled:text-ink-green-2 disabled:border-outline-green-2",
      },
      {
        variant: "outline",
        theme: "red",
        className:
          "text-ink-red-4 border border-outline-red-2 hover:border-outline-red-3 active:border-outline-red-4 active:bg-surface-red-4 disabled:bg-surface-red-2 disabled:text-ink-red-2 disabled:border-outline-red-2",
      },
      {
        variant: "outline",
        theme: "violet",
        className:
          "text-ink-violet-4 border border-outline-violet-2 hover:border-outline-violet-3 active:border-outline-violet-4 active:bg-surface-violet-4 disabled:bg-surface-violet-2 disabled:text-ink-violet-2 disabled:border-outline-violet-2",
      },
      {
        variant: "outline",
        theme: "amber",
        className:
          "text-ink-amber-4 border border-outline-amber-2 hover:border-outline-amber-3 active:border-outline-amber-4 active:bg-surface-amber-4 disabled:bg-surface-amber-2 disabled:text-ink-amber-2 disabled:border-outline-amber-2",
      },
      // Ghost buttons
      {
        variant: "ghost",
      ...
      },
      {
        ...
        theme: "violet",
        className:
          "text-ink-violet-4 hover:bg-surface-violet-3 active:bg-surface-violet-4 disabled:text-ink-violet-2",
      },
      {
        variant: "ghost",
        theme: "amber",
        className:
          "text-ink-amber-4 hover:bg-surface-amber-3 active:bg-surface-amber-4 disabled:text-ink-amber-2",
      },
      // Link buttons
      {
        variant: "link",
...
function Button({
  ...
  return (
    <Comp
      ...
      data-size={size}
      data-theme={theme}
      className={cn(buttonVariants({ variant, size, theme, isIconButton, className }))}
      {...props}
    />
  )
}
